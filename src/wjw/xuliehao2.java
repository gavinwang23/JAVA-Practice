...
public class xuliehao2 extends JFrame implements ActionListener , KeyListener{
	...
	public void keyReleased(KeyEvent l) {
		...
		if(b1>4) {
			text1.setText(null);
			text1.setText(a1.substring(0, 4));
		}
		if(b2>4) {
			text2.setText(null);
			text2.setText(a2.substring(0, 4));
		}
		if(b3>4) {
			text3.setText(null);
			text3.setText(a3.substring(0, 4));
		}
	}
